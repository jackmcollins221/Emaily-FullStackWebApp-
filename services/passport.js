...
passport.use(new GoogleStrategy({
...
}, (accessToken, refreshToken, profile, done)=>{ //this function is called whenver a user is redireted back to my project
    ...
    .then((existingUser)=>{ //runs after searching
        if(existingUser){
            //record exists
            console.log('user already exists')
        }else{
            //save the new user.
            new User({googleID : profile.id}).save()// says hey make me a user with googleID = the google profile ID
